        ...
        <div class="row card-alur-wrapper">                    
            <div class="col-md-8">
                <div class="card-alur desc">
                  ...
                  <br>
                  <p><strong>Mentor :</strong>&nbsp; {{$datas->mentor}}</p>
                  <br>
                  ...
                  <div class="row profil-bumdes">
                      <div class="row profil-wrapper col-lg-12 col-md-12 col-12" style="margin:0px;">                                                                       
            ...
            <div class="col-md-4">
              <div class="card-alur photo-produk">
                ...
                @if(!Session::has('id_bumdes'))
                    <button class="btn btn-warning w-100" onclick="alert('Anda Harus Login Dulu')"><span class="fa fa-sign-in-alt"></span>&nbsp; Ikuti Pelatihan Ini</button>                    
                @else
                    <a href="{{url('/enroll/'.$datas->id_pelatihan)}}" class="btn btn-warning w-100"><span class="fa fa-sign-in-alt" ></span>&nbsp; Ikuti Pelatihan Ini</a>                    
                @endif  
                </div>
              </div>                
            </div>      
