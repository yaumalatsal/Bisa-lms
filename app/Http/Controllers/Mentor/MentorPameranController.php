...
class MentorPameranController extends Controller
{
    public function index(){
        ...
        return view('mentor/pameran/produk')->with(compact('products'));
    }
    ...
    public function detail($id){
        ...
        return view('mentor/pameran/detail_produk')
        ->with(compact(
            'produk',
            'track',
            'masterstep',
    ...
    public function result_bmc($id_bmc,$id_produk){
        ...
        return view('mentor/pameran/detail_result_bmc')->with(compact('getResult','getmaster'));
    }
}
