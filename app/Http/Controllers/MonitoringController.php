...
class MonitoringController extends Controller
{
    public function index()
    {
        ...
        $monthlyReports = MonthlyReport::where('product_id', $product_id)
            ->where('status', 'disetujui') // Hanya menampilkan laporan yang disetujui
            ->get();
        if ($monthlyReports->isEmpty()) {
            return view('monitoring.index', [
                'message' => 'Siswa has not inputted any reports yet.',
                'monthlyReports' => null
            ]);
        }
        ...
        $previousMonthReports = MonthlyReport::where('product_id', $product_id)
            ->where('status', 'disetujui') // Hanya menampilkan laporan yang disetujui
        ...
        $currentYearProducts = MonthlyReport::where('product_id', $product_id)
        ...
        $previousYearProducts = MonthlyReport::where('product_id', $product_id)
    ...
    public function investorMonitoring($product_id)
    {
        ...
        if ($monthlyReports->isEmpty()) {
            return view('investor.page.monitoring', [
                'message' => 'Siswa has not inputted any reports yet.',
                'monthlyReports' => null
            ]);
        }
        ...
        return view('investor.page.monitoring', compact(
            // 'siswa',
            'monthlyReports',
            'currentSell',
            'previousYearProducts',
    ...
    public function mentorMonitoring($product_id)
    {
        ...
        return view('mentor.pameran.monitoring', compact(
            // 'siswa',
            'monthlyReports',
            'currentSell',
            'previousYearProducts',
